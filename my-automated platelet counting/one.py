...
filenames = [img for img in glob.glob("./45.bmp")]
...
for bb,imgs in enumerate(filenames):
    ...
    cv2.imwrite("platelets.jpg", platelets)
    ...
    # cv2.imwrite('./WBC/sample{}.jpg'.format(bb+1), drawing)
    cv2.imwrite('./PLATELETS/sample{}.jpg'.format(bb+1), drawing2)
